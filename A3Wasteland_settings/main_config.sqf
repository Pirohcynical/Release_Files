...
A3W_spawnBeaconSpawnHeight = 800; // Altitude in meters at which players will spawn when using spawn beacons (0 = ground/sea)
...
A3W_combatAbortDelay = 20;         // If playerSaving = 1, delay in seconds for which to disable abort and respawn buttons after firing or being shot (0 = none)
